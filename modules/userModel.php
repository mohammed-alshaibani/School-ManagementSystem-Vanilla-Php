                ...
                if(strpos($id, "'") === false && strpos($id, "'") === false)
                {
                    ...
                    if(mysqli_num_rows($selectQueryResult))
                    {
                        ...
                        <div style="color:green">
                            ...
                            $viewPath = "modules/Employee/View/employeeView.php"; // Updated URL path
                            header("refresh:1;url=$viewPath?access=$accessCode");
                            
                            // Load the employeeView.php file
                            require_once($viewPath);
                            exit(); // Terminate further script execution after including the file
